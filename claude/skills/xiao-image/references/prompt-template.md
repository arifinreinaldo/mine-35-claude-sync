...
Generate each image separately. Fill the variables from the article; never collage multiple shots into one image.
...
Structure type:
{structure type: Workflow / System close-up / Before-after / Character states / Concept metaphor / Layered method / Map-route / Mini comic strip}

Core idea:
{the one idea this image must land}

Composition:
{the concrete scene: where Xiaohei is, what Xiaohei is doing, the main props, how information flows}
